...
export const FEATURES: Feature[] = [
  ...
  },
  {
    id: "goal",
    label: "目標・レース",
    description: "目標タイムと出場レースの登録。冬季・基礎構築モードの切替とプランの再生成もここ",
    href: "/goal",
    keywords: [
      "目標", "ゴール", "goal", "レース", "race", "試合", "大会", "target",
      "再生成", "プラン生成", "作り直し", "メニュー生成",
      // レースが決まっていない期間の探し方
      "冬季", "冬", "オフシーズン", "off season", "基礎", "基礎構築", "土台",
      "レース未定", "期分け", "ピリオダイゼーション", "ピーキング",
    ],
  },
  ...
  },
  {
    id: "plan-settings",
    label: "メニュー設定",
    description: "曜日またはN日周期の枠、自作メニューの登録、他選手メニューの換算",
    href: "/plan-settings",
    keywords: [
      "メニュー", "曜日", "固定", "テンプレート", "自作", "オリジナル", "登録",
      "他の選手", "換算", "借りる", "設定ペース",
      // 7日にこだわらない組み方を探すときの言い方
      "周期", "サイクル", "10日", "9日", "11日", "何日", "日数", "ローテーション",
    ],
  },
  {
    id: "heat",
  ...
  {
    id: "phrase-suggest",
    label: "読み方の候補を出す（表記辞書）",
    description: "読めなかった行について、辞書に入れる語の案を出す。登録すると次からは自動で読む",
    href: "/past",
    where: "過去データの一括入力 → 解釈する → 読めなかった行",
    keywords: [
      "辞書",
      "表記",
      "覚えさせる",
  ...
  },
  {
    id: "photo-transcribe",
    label: "写真から練習日誌を読み取る",
    description: "写真の文字を起こして入力欄に入れる。日誌にもコーチのメニューにも使える",
    href: "/past",
    where: "過去データの一括入力（日誌）／カレンダーの✎（これからのメニュー）",
    keywords: [
      "写真",
      "しゃしん",
      "画像",
  ...
  },
  {
    id: "ask",
    label: "相談（AI）",
    description: "「なんでこの数字なのか」を今のデータをもとに説明してもらう",
    href: "/ask",
    where: "設定 → 分からないとき → 相談（AI）",
    keywords: [
      "相談",
      "ai",
      "聞く",
